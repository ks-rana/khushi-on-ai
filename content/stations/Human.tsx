  ...
  return (
    <Prose>
      ...
      <p className="note-block">
        <strong>Limitations &mdash; read this first.</strong> This is an informal
        class exercise, not a formal study. The design is deliberately small and
        imperfect: one human participant (me, an admittedly dry texter), ten short
        trials, and an LLM (ChatGPT) acting as the judge. For each trial, the five
        questions were generated by ChatGPT within a different thematic domain to
        vary topics, and both the AI and I answered them; ChatGPT then scored each
        answer for &ldquo;human-likeness.&rdquo; It is meant for curiosity and fun
        &mdash; to see how one version of an LLM&rsquo;s writing gets scored &mdash;
        and the headline result (the AI scoring higher than me) mostly reflects the
        judge&rsquo;s narrow stereotype of &ldquo;human&rdquo; writing, not a
        rigorous finding. Please don&rsquo;t read it as science.
      </p>
      ...
      <p className="note-block">
        <strong>Methodology, in brief.</strong> Ten trials. In each, five questions
        within a per-trial thematic domain; both the AI and I answered all five,
        and ChatGPT scored every answer for human-likeness on a 3-point scale.
        One human reference point &mdash; me (n=1). Positions were swapped halfway
        through so the judge couldn&rsquo;t simply favour one slot. The setup is
        transparent by design: the judge is explicitly an AI, so no human was
        deceived. None of this makes it rigorous &mdash; see the limitations note
        above.
      </p>
